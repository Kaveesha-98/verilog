...
HD_PWD='E:/verilog/project_clock/project_clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_mover.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_mover.tcl -notrace
