...
HD_PWD='E:/verilog/project_clock/project_clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_mover.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_mover.tcl
