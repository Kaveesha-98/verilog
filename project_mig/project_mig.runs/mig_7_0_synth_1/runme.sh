...
HD_PWD='E:/verilog/project_mig/project_mig.runs/mig_7_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mig_7_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mig_7_0.tcl
